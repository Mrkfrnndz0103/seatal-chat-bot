...
This API is limited to 300 requests per minute under one app ID.
...
The platform(s) where the message can be viewed fully and acted on (e.g., tapping a button on an interactive message card)
...
The message to be sent out, for the composition of this object please refer to the table below
...
The type of the message, in this case "file"
...
Maximum 5MB and Minimum 10 B after encoding
...
The information about the Markdown message
...
The content of the message using the Markdown syntax
