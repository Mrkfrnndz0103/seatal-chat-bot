...
event_type string
The type of the event. It will be "new_message_received_from_thread" in this case
...
For more details on supported message types for bots, refer to this document.
